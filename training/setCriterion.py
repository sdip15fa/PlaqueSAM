...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_class: float = 2, cost_bbox: float = 5, cost_giou: float = 2, focal_alpha = 0.25):
        """Creates the matcher
        Params:
...
class SetCriterion(nn.Module):
    ...
    """
    def __init__(self, num_classes, matcher, weight_dict, focal_alpha, gamma, losses, image_size):
    ...
    def forward(self, outputs, targets, return_indices=False):
        ...
        for loss in self.losses:
            losses.update(self.get_loss(loss, outputs_boxes, targets, indices, num_boxes))
